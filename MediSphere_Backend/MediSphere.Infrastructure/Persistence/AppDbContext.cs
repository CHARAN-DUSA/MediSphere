...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Appointment>()
            .HasOne(a => a.Patient).WithMany(p => p.Appointments).HasForeignKey(a => a.PatientId).IsRequired(false).OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<Appointment>()
    ...
    new Department { Id = 10, Name = "Oncology", Description = "Cancer diagnosis and treatment", IconUrl = "biotech", CreatedAt = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
        ...
        modelBuilder.Entity<PaymentTransaction>()
            ...
            .HasColumnType("decimal(18,2)");
        modelBuilder.Entity<PaymentTransaction>()
            .Property(t => t.RefundAmount)
            .HasColumnType("decimal(18,2)");

        modelBuilder.Entity<Appointment>()
            .HasIndex(a => a.IsBlockedSlot);
