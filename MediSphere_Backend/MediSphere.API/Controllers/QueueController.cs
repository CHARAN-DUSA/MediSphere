    ...
    INotificationService notificationService)
{
    ...
    public async Task<ActionResult<ApiResponse<AppointmentDto>>> CallNextPatient(int doctorId)
    {
        try
        {
            ...
            if (nextAppointment.PatientId.HasValue)
            {
                await _signalRService.NotifyQueuePositionChangedAsync(nextAppointment.PatientId.Value, nextAppointment.QueueToken, "InConsultation");
            }
    ...
    .FirstOrDefaultAsync(a => a.Id == appointmentId);
            ...
            if (appointment.PatientId.HasValue)
            {
                await _signalRService.NotifyQueuePositionChangedAsync(appointment.PatientId.Value, appointment.QueueToken, req.QueueStatus);
            }
