...
import { Appointment, CreateAppointmentDto, CancelAppointmentRequest } from '../models/appointment.model';
...
export class AppointmentService {
  ...
  cancelAppointment(id: number, payload?: CancelAppointmentRequest) {
    return this.http.delete<ApiResponse<void>>(`${this.baseUrl}/${id}`, {
      body: payload || { reasonType: 1, reason: 'Patient requested cancellation' }
    });
  }
